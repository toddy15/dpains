...
class BDController extends Controller
{
    ...
    public function __invoke(Request $request, int $year = 0): View
    {
        ...
        foreach ($vk_in_month as $employee_id => $data) {
            ...
            $sum_of_months_with_vk_1 = array_sum(array_filter(array_slice($data, 0, 6), fn ($value): bool => $value == 1));
            ...
            $sum_of_months_with_vk_1 = array_sum(array_filter(array_slice($data, 6, 6), fn ($value): bool => $value == 1));
            if ($sum_of_months_with_vk_1 >= 3) {
